...
//
// cdnjs.cloudflare.com is required only because src/app/pipeline/page.tsx
// injects Chart.js from the CDN at runtime. chart.js is already a dependency —
// import it instead and this entry can be dropped.
const CSP = [
  "default-src 'self'",
