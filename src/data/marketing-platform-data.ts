...
export interface MarketOverview {
  ...
  costCurrency?: 'DKK'        // if set, cost-per-contact/deal display in this currency
  costConversionRate?: number  // multiply spend by this to get costCurrency amount
  rows: PlatformRow[]
...
export const PLATFORM_DATA_2026: MarketOverview[] = [
  ...
  },
  {
    ...
    currency: 'EUR',
    costCurrency: 'DKK',
    costConversionRate: 7.46,  // HubSpot's EUR→DKK rate; keeps Cost/Contact in DKK matching HubSpot
    // No AT LinkedIn account in HubSpot Ads Manager
